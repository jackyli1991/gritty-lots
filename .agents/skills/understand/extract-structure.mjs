...
export { analyzeFileWithOutcomes, buildResult } from './extract-structure-result.mjs';
...
async function main() {
  ...
  for (const file of batchFiles) {
    ...
    const { analysis, callGraph, structureOutcome, callGraphOutcome } = analyzeFileWithOutcomes(
      registry,
      file,
      content
    );
